...
<div className='flex flex-col mt-6 gap-12'>
    ...
    <input type="text" value={count} onChange={handleChange}  className={`border cursor-pointer text-white border-none py-1.5 px-10 xl:py-3 bg-[#19406a]  md:w-3/12 xl:3/12 w-3/6 mx-auto rounded-xl`}/>
