...
const Card = () => {
  return (
    <div className='h-[300px] sm:h-[250px] mt-30 w-[200px]   lg:mt-0 xl:top-25  xl:w-[200px] lg:col-span-1 xl:left-[25%]  md:h-[290px] lg:h-[240px]   lg:absolute bg-white   sm:w-2/7  md:w-2/7 lg:w-2/12   rounded-lg shadow-md lg:top-20   lg:left-[23%]'>
