...
const Card = () => {
  return (
    <div className='h-[330px]  mt-20 sm:mt-0 sm:h-1/4 md:h-[290px] lg:h-[260px]  lg:absolute bg-white   sm:w-2/7 w-2/4 md:w-2/7 lg:w-1/7   rounded-lg shadow-md lg:top-19   lg:left-71'>
