...
const FatCard = () => {
  return (
    <div className=" w-4/5 sm:w-3/6 lg:col-span-2 xl:mt-[5%]  xl:right-[25%] lg:w-3/10 mt-5 md:mt-0 md:w-5/10  lg:h-[300px]    h-[320px]   md:h-[300px] sm:h-1/4  bg-[#fefefe] rounded-lg shadow-md flex  items-center lg:mt-[7%]  lg:absolute   lg:right-[27%]  ">
      <div className=" sm:h-8/9 lg:h-full md:h-[250px] lg:w-full w-[400px] flex flex-col mx-auto sm:mx-0">
