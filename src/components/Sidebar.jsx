...
const Sidebar = ({side}) => {
  ...
  return (
    <div className={`bg-white transition lg:block duration-700 ease-in-out h-full lg:h-full   w-3/5 lg:w-1/5 z-10 sm:w-3/5 md:w-1/4 absolute left-0 top-0 ${side ? "block": "hidden"} lg:block shadow-md`}>
