...
const Sidebar = ({side}) => {
  ...
  return (
    <div className={`bg-white z-10 transition duration-700 ease-in-out h-full lg:h-full   w-3/5 lg:w-3/5 sm:w-1/5 md:w-2/5 absolute left-0 top-0 ${side ? "": "hidden"}  shadow-md`}>
